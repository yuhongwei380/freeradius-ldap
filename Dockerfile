...
RUN cp config/default /etc/freeradius/sites-available/default
RUN cp config/inner-tunnel /etc/freeradius/sites-available/inner-tunnel
RUN cp config/ldap.template /etc/freeradius/3.0/mods-available/ldap
